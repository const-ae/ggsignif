...
This is important if you use `position="dogde"`, because in that case I cannot calculate the correct position
...
with `facet_wrap` or `facet_grid`. In those cases it you can set the flag `manual=TRUE` and provide the annoations
as a data.frame:
